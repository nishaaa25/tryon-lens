...
export default function StepOneForm({ uploadedImageUrl = null }: { uploadedImageUrl?: string | null }) {
  ...
  return (
    <div className="flex flex-col w-full h-full relative z-100 leading-[120%] gap-5">
      ...
      {/* Top – single card UI (same layout as former Single Clothes) */}
        ...
        <div className="rounded-xl w-full relative overflow-hidden border border-gray-200 bg-white">
          ...
          <div className="grid grid-cols-2 gap-4 p-4 relative">
            <div className="w-full relative flex flex-col gap-3">
              ...
              <div className="w-full relative h-80 rounded-xl overflow-hidden bg-gray-50">
                {uploadedImageUrl ? (
                  <img
            ...
            <div className="w-full relative flex flex-col gap-3">
              ...
              <div className="w-full relative h-80 border border-dashed border-[#cacfd8] p-3 flex flex-col justify-center items-center gap-3.5 rounded-xl overflow-hidden">
      ...
      {/* Bottom – single card UI (same layout as former Single Clothes) */}
